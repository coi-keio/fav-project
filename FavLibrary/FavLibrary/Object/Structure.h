...
//    };
    ...
    public:
        ...
        void setColorRGB(Point p_, int r_, int g_, int b_);
        void setColorRGBA(Point p_, int r_, int g_, int b_, int a_);
        void setColorCMYK(Point p_, int c_, int m_, int cy_, int k_);
        void setColortGrayScale(Point p_, int k);
        void setColortGrayScale16(Point p_, int k);
        void setColorAlpha(Point p_, int a_);
        ...
        int getColorGreen(Point p_);
        int getColorBlue(Point p_);
        int getColorCyan(Point p_);
        int getColorMagenta(Point p_);
        int getColorYellow(Point p_);
        int getColorKeyPlate(Point p_);
